...
class EditProfileActivity : org.hiveway.BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hivewayApi.accountVerifyCredentials().enqueue(object : Callback<Account> {
    ...
    private fun save() {
        ...
        hivewayApi.accountUpdateCredentials(displayName, note, avatar, header).enqueue(object : Callback<Account> {
            override fun onResponse(call: Call<Account>, response: Response<Account>) {
                if (!response.isSuccessful) {
                    onSaveFailure()
                    return
    ...
    private class ResizeImageTask (private val contentResolver: ContentResolver,
        ...
        override fun doInBackground(vararg uris: Uri): Boolean? {
            ...
            try {
                ...
                org.hiveway.util.IOUtils.closeQuietly(inputStream)
            }
        ...
        fun saveBitmapToFile(bitmap: Bitmap, file: File): Boolean {
            ...
            org.hiveway.util.IOUtils.closeQuietly(outputStream)
