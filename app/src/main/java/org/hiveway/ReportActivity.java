...
import org.hiveway.adapter.ReportAdapter;
...
public class ReportActivity extends BaseActivity {
    ...
    private void sendReport(final String accountId, final String[] statusIds,
        ...
        hivewayApi.report(accountId, Arrays.asList(statusIds), comment)
                .enqueue(callback);
    }
    ...
    private void fetchRecentStatuses(String accountId) {
        ...
        hivewayApi.accountStatuses(accountId, null, null, null, null)
                .enqueue(callback);
    }
