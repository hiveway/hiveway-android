...
import org.hiveway.view.SquareImageView
...
class AccountMediaFragment : org.hiveway.fragment.BaseFragment() {
    ...
    private lateinit var api: HivewayApi
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        api = (activity as org.hiveway.BaseActivity).hivewayApi
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val bgRes = org.hiveway.util.ThemeUtils.getColorId(context, R.attr.window_background)
    ...
    private fun viewMedia(items: List<Attachment>, currentIndex: Int, view: View?) {
        ...
        when (type) {
            Attachment.Type.IMAGE -> {
                val intent = Intent(context, org.hiveway.ViewMediaActivity::class.java)
            ...
            Attachment.Type.GIFV, Attachment.Type.VIDEO -> {
                val intent = Intent(context, org.hiveway.ViewVideoActivity::class.java)
