...
public class MainActivity extends BaseActivity implements ActionButtonActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // account switching has to be done before HivewayApi is created in super.onCreate
        ...
        if (intent != null) {
            ...
            if(accountId != -1) {
                ...
                tabPosition = 1;
                AccountEntity account = HivewayApplication.getAccountManager().getActiveAccount();

                if (account == null || accountId != account.getId()) {
                    HivewayApplication.getAccountManager().setActiveAccount(accountId);
                }
            }
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == COMPOSE_RESULT && resultCode == RESULT_OK) {
    ...
    private void setupDrawer() {
        headerResult = new HivewayAccountHeaderBuilder()
                .withActivity(this)
                ...
                .withOnDrawerItemClickListener((view, position, drawerItem) -> {
                    if (drawerItem != null) {
                        ...
                        if (drawerItemIdentifier == DRAWER_ITEM_EDIT_PROFILE) {
                            ...
                            startActivity(intent);
                        } else if (drawerItemIdentifier == DRAWER_ITEM_SAVED_POST) {
    ...
    private void changeAccount(long newSelectedId) {
        HivewayApplication.getAccountManager().setActiveAccount(newSelectedId);
        ...
        if(activeAccount != null) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, (dialog, which) -> {
                        ...
                        AccountManager accountManager = HivewayApplication.getAccountManager();
    ...
    private void fetchUserInfo() {
        ...
        hivewayApi.accountVerifyCredentials().enqueue(new Callback<Account>() {
            @Override
    ...
    private void onFetchUserInfoSuccess(Account me) {
        ...
        AccountManager am = HivewayApplication.getAccountManager();
