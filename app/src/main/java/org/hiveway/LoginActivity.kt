...
import org.hiveway.entity.AccessToken
import org.hiveway.entity.AppCredentials
...
class LoginActivity : AppCompatActivity() {
    ...
    private var domain: String = "hiveway.net"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val theme = preferences.getString("appTheme", org.hiveway.HivewayApplication.APP_THEME_DEFAULT)
        org.hiveway.util.ThemeUtils.setAppNightMode(theme)
    ...
    private fun getApiFor(domain: String): HivewayApi {
        val retrofit = Retrofit.Builder()
                .baseUrl("https://" + domain)
                .client(org.hiveway.util.OkHttpUtils.getCompatibleClient(preferences))
                .addConverterFactory(GsonConverterFactory.create())
                .build()

        return retrofit.create(HivewayApi::class.java)
    }
    ...
    private fun onButtonClick() {
        ...
        val callback = object : Callback<AppCredentials> {
            override fun onResponse(call: Call<AppCredentials>,
                ...
                if (!response.isSuccessful) {
                    ...
                    domainEditTextError.text = getString(R.string.error_failed_app_registration)
                ...
                redirectUserToAuthorizeAndLogin(domainEditTextError)
            }
        ...
        try {
            ...
            setLoading(false)
            domainEditTextError.text = getString(R.string.error_invalid_domain)
        }

    }

    private fun redirectUserToAuthorizeAndLogin(editText: TextView) {
        /* To authorize this app and log in it's necessary to redirect to the domain given,
         * activity_login there, and the server will redirect back to the app with its response. */
        val endpoint = HivewayApi.ENDPOINT_AUTHORIZE
        ...
        if (!openInCustomTab(uri, this)) {
            ...
            if (viewIntent.resolveActivity(packageManager) != null) {
                ...
                editText.text = getString(R.string.error_no_web_browser_found)
                setLoading(false)
            }
        }
    }
    ...
    override fun onStart() {
        ...
        if (uri != null && uri.toString().startsWith(redirectUri)) {
            ...
            if (code != null) {
                ...
                val callback = object : Callback<AccessToken> {
                    override fun onResponse(call: Call<AccessToken>, response: Response<AccessToken>) {
                        if (response.isSuccessful) {
                            ...
                            setLoading(false)
                            domainEditTextError.text = getString(R.string.error_retrieving_oauth_token)
                 ...
                 * can try again. */
                setLoading(false)
                domainEditTextError.text = getString(R.string.error_authorization_denied)
                Log.e(TAG, String.format("%s %s",
                ...
                setLoading(false)
                domainEditTextError.text = getString(R.string.error_authorization_unknown)
            }
        } else {
    ...
    private fun onLoginSuccess(accessToken: String) {
        ...
        org.hiveway.HivewayApplication.getAccountManager().addAccount(accessToken, domain)

        val intent = Intent(this, org.hiveway.MainActivity::class.java)
    ...
    companion object {
        ...
        private fun openInCustomTab(uri: Uri, context: Context): Boolean {
            ...
            val toolbarColor = org.hiveway.util.ThemeUtils.getColorById(context, "custom_tab_toolbar")
            val builder = CustomTabsIntent.Builder()
            builder.setToolbarColor(toolbarColor)
            val customTabsIntent = builder.build()
            try {
                val packageName = org.hiveway.util.CustomTabsHelper.getPackageNameToUse(context)
