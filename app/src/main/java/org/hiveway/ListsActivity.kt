...
import org.hiveway.entity.MastoList
...
class ListsViewModel(private val api: HivewayApi) {
...
class ListsActivity : org.hiveway.BaseActivity(), ListsView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = lastNonConfigurationInstance as? ListsViewModel ?: ListsViewModel(hivewayApi)
    ...
    override fun openTimeline(listId: String) {
        startActivity(
                ModalTimelineActivity.newIntent(this, org.hiveway.fragment.TimelineFragment.Kind.LIST, listId))
    }
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
            return LayoutInflater.from(parent.context).inflate(R.layout.item_list, parent, false)
                    ...
                    .apply {
                        ...
                        org.hiveway.util.ThemeUtils.setDrawableTint(context, icon, android.R.attr.textColorTertiary)
