...
import org.hiveway.db.AppDatabase;
...
public class HivewayApplication extends Application {
    ...
    public void onCreate() {
        ...
        db = Room.databaseBuilder(getApplicationContext(), AppDatabase.class, "hivewayDB")
