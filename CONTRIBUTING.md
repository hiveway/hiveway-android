...
2. Clone your fork to your machine. ```git clone https://github.com/<Your_Username>/hiveway-android```
...
If you have any questions, don't hesitate to open an issue or contact us.
